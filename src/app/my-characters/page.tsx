  ...
  return (
    <AppShell>
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-8">
        <PageHeader
          title="My characters"
          subtitle="Every character you've created. Edit them or delete them here."
          action={<Link href="/create" className="btn-primary">Create new</Link>}
        />
        {!user ? (
          <div className="text-center py-20">
            <div className="text-5xl mb-4">🎭</div>
            <p className="text-text-dim mb-4">Sign in to see the characters you&apos;ve made.</p>
          ...
          <div className="text-center py-20">
            <div className="text-5xl mb-4">✨</div>
            <p className="text-text-dim mb-1">You haven&apos;t created any characters yet.</p>
            <p className="text-text-faint text-sm mb-4">Every world begins with a first character.</p>
            <Link href="/create" className="btn-primary">Create your first character</Link>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {chars.map((c) => (
